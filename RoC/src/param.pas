...
uses
  ...
  IniPropStorage, ComCtrls, CheckLst, ExtCtrls, Menus, RoCConsts, Main,
  inifiles, rtdb_api;
...
type
  ...
  TFParam = class(TForm)
    ...
    procedure EditSimIPChange(Sender: TObject);
...
begin
  ...
  rt:= RGRobotNumber.ItemIndex;
 // rtdb_api.DB_put(myNumber, @rt);
...
procedure TFParam.EditSimIPChange(Sender: TObject);
begin
